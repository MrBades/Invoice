...
3. **Prioritize Fluid Compute.** PDF generation (e.g. `xhtml2pdf`) can be memory-heavy. Always ensure `vercel.json` configurations allocate enough processing time/memory for these endpoints.
